...
CREATE TABLE `documents` (
  ...
  `indert_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
...
INSERT INTO `documents` (`id`, `name`, `delete_status`, `indert_date`) VALUES
(1, 'New_Text_Document1.txt', 0, '2019-03-30 18:13:57'),
(2, 'New_Text_Document_-_Copy.txt', 0, '2019-03-30 18:14:40'),
(3, 'New_Text_Document2.txt', 0, '2019-03-30 18:14:55'),
(4, 'New_Text_Document3.txt', 0, '2019-03-30 18:15:35'),
(5, 'file2.txt', 0, '2019-04-01 17:50:08'),
(6, 'file3.txt', 0, '2019-04-01 17:50:16'),
(7, 'search_1.txt', 0, '2019-04-08 15:06:54'),
(8, 'search_11.txt', 0, '2019-04-08 15:12:11'),
(9, 'search_12.txt', 0, '2019-04-08 15:15:02'),
(10, 'HTML_Basics.pdf', 0, '2019-04-08 15:17:09');
