              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Search Files</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                            ...
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">              
                                        <input type="text" id="search_key" class="form-control required" required="" >
                                    </div>                                    
                                </div><div class="col-md-4">
                            <button class="btn btn-primary" id="search">search</button> 
                            <a class="btn btn-primary" href="<?php echo base_url('searchFile');?>">reset</a>
                            
                        </div>
                        <div class="col-md-12"> <label></label>                               
                                    <div class="form-group" id="keys"></div></div>
                        <div class="col-md-12">                                
